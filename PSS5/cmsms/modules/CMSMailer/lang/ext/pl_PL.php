...
$lang['moddescription'] = 'To jest prosty wrapper dla PHPMailera, posiada odpowiednik API (funkcja dla funkcji) oraz prosty interfejs dla wartości domyślnych. Ten moduł jest deprecjonowany od wersji CMSMS 2.0';
