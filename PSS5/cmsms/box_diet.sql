...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Maj 2023, 23:43
...
--
CREATE DATABASE IF NOT EXISTS `box_diet` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `box_diet`;
...
CREATE TABLE `calorities` (
  `CalorityID` int(11) NOT NULL,
  `Weight` int(11) NOT NULL,
  `Height` int(11) NOT NULL,
  `Age` int(11) NOT NULL,
  `PhysicalActivity` int(11) NOT NULL,
  `CaloricRequirement` int(11) NOT NULL,
...
CREATE TABLE `diets` (
  ...
  `CalorificValue` int(11) NOT NULL,
  `NumberOfDishes` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `roles` (
  ...
  `RuleName` int(11) NOT NULL,
  `Permissions` int(11) NOT NULL,
  `RuleDescription` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `rolesassignation` (
  `DateOfRoleAssignation` int(11) NOT NULL,
  `DateOfRoleRemoving` int(11) NOT NULL,
  `RoleAssignationID` int(11) NOT NULL,
  `RecordCreator` int(11) NOT NULL,
  `RecordModifier` int(11) NOT NULL,
  `UserID` int(11) NOT NULL,
  `RoleID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('root', '[{\"db\":\"box_diet\",\"table\":\"calorities\"},{\"db\":\"box_diet\",\"table\":\"diets\"}]');
...
('root', '2023-05-07 20:59:24', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
